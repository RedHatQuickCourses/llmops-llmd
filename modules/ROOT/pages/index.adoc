...
This course is a technical level 2 (TL2) experience designed for implementers, architects, consultants, and operators who are responsible for running Generative AI workloads at scale.

We begin by tackling the core market challenge: the reality that ad-hoc AI experiments often fail to deliver ROI due due to skyrocketing OpEx and relying on monolithic, hard-to-scale architectures. This course provides the concepts of usign llm-d to transform those experiments into a repeatable, scalable, and economically viable Intelligence Factory on Red Hat OpenShift AI.
...
*   Use a Workbench & Jupyter Notebook to insure inference is working.
...
Special thanks to Fernando Lozano and Stephen Buck for all their support while writing this course and their feedback on early versions.

Many thanks to Naina Singh for her support in reviewing the course design, its outline, work-in-progress contents, and answering my newbie questions, and also to Philip Hays for excellent llm-d deployment instructions for RHOAI 2.25 & 3.0.